...
1. Разработать класс [скачать проект](https://github.com/EPM-RD-NETLAB/.NET-Framework-modules/blob/master/M13.%20Streams%20and%20IO/SourceText.txt), предоставляющий следующие функциональные возможности : 
