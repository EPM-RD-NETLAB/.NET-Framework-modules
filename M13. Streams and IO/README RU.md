...
2. Протестировать работу класса для текстового файла [] в консоли, обратить внимание на содержимое файлов, полученных при копировании с помощью различных методов класса. Результаты сравнить, сделать выводы.
